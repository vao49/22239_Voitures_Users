// Fonctions utiles
export function get(urlA, fonctSuccess, fonctError) {
  var requestOptions = {
    method: "GET",
    redirect: "follow",
  };
...
export function post(urlA, donnees, fonctSuccess, fonctError) {
  var requestOptions = {
    method: "POST",
    body: donnees,
    redirect: "follow",
...
export function put(urlA, donnees, fonctSuccess, fonctError) {
  var requestOptions = {
    method: "PUT",
    body: donnees,
    redirect: "follow",
...
export function del(urlA, fonctSuccess, fonctError) {
