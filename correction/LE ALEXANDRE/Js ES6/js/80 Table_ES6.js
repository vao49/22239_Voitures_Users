...
import { RetourAjax, fonction_vue, fonction_modif, Suppr, ErreurAjax } from "./main_ES6.js";
export { CreaTab};


// Creation tableau Voitures
function CreaTab(reponse) {
    ...
    // Génération de <thead>
    let header = ["Code", "Marque", "Couleur", "Cylindrée"];
    ...
    myObj.voitures.records.forEach(ligne => {
        ...
        btn_vue_genere.addEventListener("click", fonction_vue, false);
        ...
        btn_modif_genere.addEventListener("click", fonction_modif, false);
        ...
        btn_suppr_genere.addEventListener("click", Suppr, false);
        ...
        get(urlApi, RetourAjax, ErreurAjax);
    });
