...
function modifStag(e) {
  ...
  window.addEventListener('load', (event) => {
    ...
    document.getElementById('btn-ajout').addEventListener('click', () => {
      let message = document.getElementById('balert');
      let emailSaisi = document.getElementById("cylindreev").value;
      ...
      if ((document.getElementById('marque_ajout').value == "") || (document.getElementById('couleur_ajout').value == "") || (document.getElementById('cylindreev').value == "")) {
        ...
        if (emailSaisi.includes("@") && emailSaisi.includes(".")) {
          ...
          if (emailSaisiCoupe.includes(".")) {
            ...
            document.getElementById('balert').innerHTML = ""
            document.getElementById('balert').innerHTML = '<div id="balert" class="alert alert-success" role="alert">Utilisateur ajouté !</div>'
